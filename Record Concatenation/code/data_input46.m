function [ patient_ID , patient_feature , feature_index ] = data_input46( File , timechoose , patient_ID ,patient_feature , feature_index)
%%
datanumber=[7:12];
completionchoose=[zeros(1,6)];
%%
...
for n=1:length(datanumber)
    feature_index=[feature_index,[RAW{1,datanumber(n)};{completionchoose(n)};{46}]];
end
end
