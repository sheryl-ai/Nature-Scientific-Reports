function [ patient_ID , patient_feature , feature_index ] = data_input49( File , timechoose , patient_ID ,patient_feature , feature_index)
%%
datanumber=[7,9,11,13,15,17,19,21,23];
...
for n=1:length(datanumber)
    feature_index=[feature_index,[RAW{1,datanumber(n)};{completionchoose(n)};{49}]];
end
end
