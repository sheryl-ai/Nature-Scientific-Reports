function [ patient_ID , patient_feature , feature_index ] = data_input39( File , timechoose , patient_ID ,patient_feature , feature_index)
%%
datanumber=[7:21,28,29,30];
completionchoose=[zeros(1,15),1,1,0];
%%
...
for n=1:length(datanumber)
    feature_index=[feature_index,[RAW{1,datanumber(n)};{completionchoose(n)};{39}]];
end
end
