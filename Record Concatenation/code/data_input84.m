function [ patient_ID , patient_feature , feature_index ] = data_input84( File , timechoose , patient_ID ,patient_feature , feature_index)
%读取表84中的数据
%%
datanumber=[7];
completionchoose=[0];
...
for n=1:length(datanumber)
    feature_index=[feature_index,[RAW{1,datanumber(n)};{completionchoose(n)};{84}]];
end
end
