function [ patient_ID , patient_feature , feature_index ] = data_input14( File , timechoose , patient_ID ,patient_feature , feature_index)
%%
datanumber=[7,8,9,10,11,12];
completionchoose=[0,0,0,0,0,0];
%%
...
for n=1:length(datanumber)
    feature_index=[feature_index,[RAW{1,datanumber(n)};{completionchoose(n)};{14}]];
end
end
