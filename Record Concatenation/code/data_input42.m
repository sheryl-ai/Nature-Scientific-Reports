function [ patient_ID , patient_feature , feature_index ] = data_input42( File , timechoose , patient_ID ,patient_feature , feature_index)
%%
datanumber=[7:13];
...
for n=1:length(datanumber)
    feature_index=[feature_index,[RAW{1,datanumber(n)};{completionchoose(n)};{42}]];
end
end
