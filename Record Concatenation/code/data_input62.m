function [ patient_ID , patient_feature , feature_index ] = data_input62( File , timechoose , patient_ID ,patient_feature , feature_index)
%%
datanumber=[9];
completionchoose=[0];
%%
...
for n=1:length(datanumber)
    feature_index=[feature_index,[RAW{1,datanumber(n)};{completionchoose(n)};{62}]];
end
end
