function [ patient_ID , patient_feature , feature_index ] = data_input11( File , timechoose , patient_ID ,patient_feature , feature_index)
...
for n=1:length(datanumber)
    feature_index=[feature_index,[RAW{1,datanumber(n)};{completionchoose(n)};{11}]];
end
end
