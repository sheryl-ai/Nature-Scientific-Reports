function [ patient_ID , patient_feature , feature_index ] = data_input44( File , timechoose , patient_ID ,patient_feature , feature_index)
%%
datanumber=[7:20];
completionchoose=[zeros(1,14)];
%%
...
for n=1:length(datanumber)
    feature_index=[feature_index,[RAW{1,datanumber(n)};{completionchoose(n)};{44}]];
end
end
